...
export type FalModel = 'fal-ai/fashion/try-on' | 'fal-ai/fashion-edit';
...
export const generateTryOn = async (personImage: string, clothingImage: string, model: FalModel = 'fal-ai/fashion/try-on') => {
  try {
